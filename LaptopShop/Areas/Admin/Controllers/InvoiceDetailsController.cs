...
namespace LaptopShop.Areas.Admin.Controllers
{
    ...
    public class InvoiceDetailsController : Controller
    {
        ...
        public InvoiceDetailsController(LaptopshopContext context)
        {
            _context = context;
        }
        ...
        {
            var laptopshopContext = _context.InvoiceDetails.Include(i => i.Invoices).Include(i => i.Products);
        ...
        public async Task<IActionResult> Create([Bind("Id,InvoiceId,ProductId,Quantity,Price")] InvoiceDetail invoiceDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,InvoiceId,ProductId,Quantity,Price")] InvoiceDetail invoiceDetail)
        {
